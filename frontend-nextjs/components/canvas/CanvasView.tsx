                ...
                {fileT1 && (
                  <div className="group relative flex-shrink-0">
                    ...
                    <button
                      ...
                      className="absolute top-1.5 right-1.5 w-5 h-5 rounded-full bg-black/60 hover:bg-rose-600 text-white flex items-center justify-center shadow-md transition-all hover:scale-110 cursor-pointer z-10"
                      title="Remove Image"
                    >
                      <X className="w-3 h-3" />
                    </button>
