...
"[project]/node_modules/geotiff/dist-module/compression/jpeg.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/** @typedef {(number|HuffmanNode)[]} HuffmanNode */ /** @typedef {{children: HuffmanNode, index: number}} Code */ /**
 ...
 */ function buildHuffmanTable(codeLengths, values) {
    ...
    /** @type {Code|undefined} */ let p = code[0];
    /** @type {Code|undefined} */ let q;
 ...
 */ function decodeScan(data, initialOffset, frame, components, resetInterval, spectralStart, spectralEnd, successivePrev, successive) {
    ...
    /** @param {HuffmanNode|undefined} tree */ function decodeHuffman(tree) {
        if (!tree) {
    ...
    /** @param {number} initialLength */ function receive(initialLength) {
    ...
    /** @param {number} length */ function receiveAndExtend(length) {
    ...
    /** @type {number} */ let successiveACNextValue;
    /**
     * @param {JpegComponent} component
     * @param {Int32Array} zz
...
class JpegStreamReader {
    constructor(){
        this.jfif = null;
        this.adobe = null;
        /** @type {number} */ this.resetInterval = 0;
        /** @type {Int32Array[]} */ this.quantizationTables = [];
        /** @type {HuffmanNode[]} */ this.huffmanTablesAC = [];
        /** @type {HuffmanNode[]} */ this.huffmanTablesDC = [];
        /** @type {JpegFrame[]} */ this.frames = [];
    }
    resetFrames() {
        this.frames = [];
    }
    /** @param {Uint8Array} data */ parse(data) {
        let offset = 0;
        // const { length } = data;
        function readUint16() {
        ...
        /** @param {JpegFrame} frame */ function prepareComponents(frame) {
            let maxH = 0;
            let maxV = 0;
            let component;
            let componentId;
                ...
                case 0xFFC2:
                    {
                        ...
                        /** @type {JpegFrame} */ const frame = {
                            extended: fileMarker === 0xFFC1,
                            progressive: fileMarker === 0xFFC2,
                            precision: data[offset++],
                            scanLines: readUint16(),
                            samplesPerLine: readUint16(),
                            /** @type {Object.<string, JpegComponent>} */ components: {},
                            /** @type {number[]} */ componentsOrder: [],
                            maxH: 0,
                            maxV: 0,
                            mcusPerLine: 0,
                            mcusPerColumn: 0
...
class JpegDecoder extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$geotiff$2f$dist$2d$module$2f$compression$2f$basedecoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    /**
...
//# sourceMappingURL=node_modules_geotiff_dist-module_1e3no_q._.js.map